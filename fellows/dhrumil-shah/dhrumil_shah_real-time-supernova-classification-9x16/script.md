...
*"Seven Million Alerts a Night"* · 16 beats · vertical 9:16 · presenter Dhrumil Shah ·
...
The original brief asked for the first 3–5 seconds to open on the scientific problem rather than on
the presenter. The introduction was then added at the presenter's explicit request. The cost is
