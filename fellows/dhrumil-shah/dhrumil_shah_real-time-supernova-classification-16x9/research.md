...
*"Seven Million Alerts a Night"* · landscape 16:9 explainer · AI in Astronomy & Space Science ·
presented by Dhrumil Shah

This is the research brief for the 16:9 cut. The science, sources and wording are shared unchanged
with the 9:16 cut in `../real-time-supernova-classification-9x16/`; only the picture differs.
