...
const OutroCard: React.FC<GodotTitleOutroProps & { portrait?: boolean }> = ({
  ...
  const titleSize = portrait ? 140 : 240;
  const kickSize  = portrait ? 50 : 58;
  const handleSize = portrait ? 58 : 70;
  const subSize   = portrait ? 48 : 52;
  ...
  return (
    <IlluStage spark="" sparkPos="top">
      ...
      <div style={{
        ...band, top: row(portrait ? 0.72 : 0.76), fontFamily: SERIF,
